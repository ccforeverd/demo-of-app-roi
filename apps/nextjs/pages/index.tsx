    ...
    <div className="flex flex-col h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          ...
          `}
        >
          <SidebarSection icon={<FaFilter />} title="筛选条件">
            <FilterBar />
          </SidebarSection>

          <SidebarSection icon={<FaSliders />} title="显示设置">
            <DisplayControls />
          </SidebarSection>

          <SidebarSection icon={<FaDatabase />} title="数据管理">
            <CsvUpload />
            ...
            <div className="h-full rounded-lg border border-border bg-card overflow-hidden">
              ...
              {roiData && roiData.length === 0 && !isLoading && (
                <div className="flex h-full min-h-[400px] flex-col items-center justify-center gap-3 text-muted-foreground">
                  <FaChartLine className="text-4xl" aria-hidden="true" />
